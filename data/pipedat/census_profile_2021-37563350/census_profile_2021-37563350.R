#' @eval get_name("37563350")
#'
#' @eval get_description("37563350")
#'
#' @eval dp_params()
#'
...
#'
#' @keywords pipeline_id: 37563350
#'
#' @examples
#' \dontrun{
#' dp_37563350()
#' }
dp_37563350 <- function(bbox = NULL, bbox_crs = NULL, timespan = NULL, ingrid = TRUE, ...) {
  uid <- "37563350"
