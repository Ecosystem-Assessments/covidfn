...
render_manuscript <- function() {
  # file.copy("./figures/", "./report/", recursive = TRUE)
  rmarkdown::render("pubs/manuscript/covidfn.Rmd")
}


#' Render manuscript supplementary material
#'
#' @export
render_manuscript_sm <- function() {
  # file.copy("./figures/", "./report/", recursive = TRUE)
  rmarkdown::render("pubs/manuscript/covidfn_sm.Rmd")
}
